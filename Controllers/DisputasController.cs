...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://vitinho011.somee.com/RpgApi/Disputas/";
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://vitinho011.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    string uriBuscaHabilidades = "http://vitinho011.somee.com/RpgApi/PersonagensHabilidades/GetHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://vitinho011.somee.com/RpgApi/Disputas/DisputaEmGrupo";
